...
\beqn
\forall \epsilon > 0, ~~\limitn \prob{|\Xbar_n - \mu| \geq \epsilon} \leq \limitn \frac{\var{\Xbar_n}}{\epsilon^2} = \limitn \frac{\sigsq / n}{\epsilon^2} = \frac{\sigsq}{\epsilon^2}\limitn \frac{1}{n} = 0 ~~\checkmark
\eeqn
}}{~\spc{8}}
